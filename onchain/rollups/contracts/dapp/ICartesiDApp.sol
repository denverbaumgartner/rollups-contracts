...
interface ICartesiDApp {
    ...
    // ADD additional events to be used 
    event LogPrompt(uint256 promptNumber, bytes payload);
    event LogFeedback(uint256 promptNumber, string textOne, string textTwo, bool isOneBetter);
